...
_racProfFacCiv = 0.5;                     //(Number) Multiplies the effect of racial profiling. Lower this number to simulate more multicultural civilian population
...
_civilianUniforms = ["U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_I_C_Soldier_Bandit_4_F","U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_5_F","U_I_C_Soldier_Bandit_3_F","RCT_Jeans_grey","RCT_khaki_black","Project_BJC_Shirt_Jean","Project_BJC_Shirt_Jean1","Project_BJC_Shirt_Jean2","Project_BJC_Shirt_Jean3","Project_BJC_PCU_Jean_blk3","Project_BJC_PCU_Jean","Project_BJC_PCU_Jean1","Project_BJC_PCU_Jean2","Project_BJC_PCU_Jean3","Project_BJC_PCU_Jean4",
